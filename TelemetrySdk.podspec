...
Pod::Spec.new do |spec|
  ...
  spec.source           = { :git => 'https://github.com/valiaga/opentelemetry-swift.git', :tag => spec.version.to_s }
  ...
  # spec.social_media_url   = "https://twitter.com/yulong.gyl"
  ...
  #  spec.source       = { :git => "http://EXAMPLE/OpenTelemetrySdk.git", :tag => "#{spec.version}" }
